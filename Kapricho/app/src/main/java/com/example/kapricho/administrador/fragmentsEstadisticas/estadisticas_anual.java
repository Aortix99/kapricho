 ...
 * Use the {@link estadisticas_anual#newInstance} factory method to
 * create an instance of this fragment.
 */
public class estadisticas_anual extends Fragment {
     ...
     * @return A new instance of fragment estadisticas_anual.
     */
    // TODO: Rename and change types and number of parameters
    public static estadisticas_anual newInstance(String param1, String param2) {
        estadisticas_anual fragment = new estadisticas_anual();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista = inflater.inflate(R.layout.fragment_estadisticas_anual, container, false);

        server = new config();
        arrayList = new ArrayList<>();
        adaptadorOrdenes = new AdaptadorOrdenes(arrayList, getActivity());

        recyclerView = vista.findViewById(R.id.recicler_fecha_anual);
        total = vista.findViewById(R.id.et_total_recaudado_anual);
        tv = vista.findViewById(R.id.tv_total_recaudado_anual);
        year_ = vista.findViewById(R.id.et_fecha_anual_year);
        buscar = vista.findViewById(R.id.button_buscar_anual);
        ...
        buscar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String fecha = year_.getSelectedItem().toString();
